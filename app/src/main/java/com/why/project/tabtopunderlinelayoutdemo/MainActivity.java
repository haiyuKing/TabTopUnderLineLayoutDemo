package com.why.project.tabtopunderlinelayoutdemo;
...
import com.why.project.tabtopunderlinelayoutdemo.views.tab.TabTopUnderLineLayout;
...
public class MainActivity extends AppCompatActivity {
	...
	private void initView(){
		mTabTopUnderLineLayout = (TabTopUnderLineLayout) findViewById(R.id.tab_top);
	...
	private void initData() {
		...
		tabTitleList.add("推荐");
		tabTitleList.add("娱乐");
		mTabTopUnderLineLayout.setTabList(tabTitleList);
	}
	...
	private void initEvent(){
		//每一个选项卡的点击事件
		mTabTopUnderLineLayout.setOnTopTabSelectedListener(new TabTopUnderLineLayout.OnTopTabUnderLineSelectListener() {
			@Override
	...
	public void SwitchTab(int checkedIndex){
		if(mTabTopUnderLineLayout != null){
			mTabTopUnderLineLayout.setTabsDisplay(checkedIndex);
		}
	}
